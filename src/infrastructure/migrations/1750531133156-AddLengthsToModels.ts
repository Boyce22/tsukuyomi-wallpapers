...
export class AddLengthsToModels1750531133156 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "user"."email" IS 'Endereço de e-mail do usuário, deve ser único (máx. 255 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "user"."profilePictureUrl" IS 'URL da foto de perfil do usuário (máx. 255 caracteres).'`);
        await queryRunner.query(`ALTER TABLE "user" ADD "bannerUrl" character varying(255)`);
        await queryRunner.query(`COMMENT ON COLUMN "user"."bannerUrl" IS 'URL do banner do perfil do usuário (máx. 255 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "role"."name" IS 'Nome único da role que identifica o conjunto de permissões (máx. 50 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "user"."userName" IS 'Nome de usuário único utilizado para login e identificação (máx. 50 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "tag"."name" IS 'Nome único da tag que identifica cada tag de forma exclusiva (máx. 50 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "tag"."description" IS 'Descrição da tag, que explica seu significado ou contexto (máx. 255 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "wallpaper"."description" IS 'Descrição detalhada do papel de parede (máx. 255 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "wallpaper"."originalUrl" IS 'URL original do arquivo da imagem (máx. 255 caracteres).'`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "wallpaper"."thumbnailUrl" IS 'URL da miniatura (thumbnail) da imagem (máx. 255 caracteres).'`);
        await queryRunner.query(`COMMENT ON COLUMN "wallpaper"."format" IS 'Formato do arquivo (exemplo: jpg, png, gif, webp).'`);
    }
